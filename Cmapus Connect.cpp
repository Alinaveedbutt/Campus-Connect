...
protected:
    ...
    int semester;
public:
    Student(string name = "", int personID = 0, string programEnrolled = "", int semester = 0)
...
protected:
    ...
    int coursesTeaching;
public:
    Faculty(string name = "", int personID = 0, string department = "", int coursesTeaching = 0)
        : Person(name, personID) {
...
protected:
    ...
    int visitDuration;
public:
    Visitor(string name = "", int personID = 0, string visitPurpose = "", int visitDuration = 0)
        : Person(name, personID) {
